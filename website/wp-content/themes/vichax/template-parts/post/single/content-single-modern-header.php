...
<div class="single-modern-header <?php echo $invert_class = has_post_thumbnail() ? 'invert' : ''; ?>">
	...
	<div class="container">
		...
		<header class="entry-header">
			...
			<?php $author_visible = vichax_is_meta_visible( 'single_post_author', 'single' );
		...
		<?php if ( 'post' === get_post_type() ) : ?>
			...
			<div class="entry-meta">
				...
				<?php $date_visible = vichax_is_meta_visible( 'single_post_publish_date', 'single' );
				...
				<?php $comment_visible = vichax_is_meta_visible( 'single_post_comments', 'single' );
				...
				<?php $cats_visible = vichax_is_meta_visible( 'single_post_categories', 'single' );
				...
				<?php $tags_visible = vichax_is_meta_visible( 'single_post_tags', 'single' );
