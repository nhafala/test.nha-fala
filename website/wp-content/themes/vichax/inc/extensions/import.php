...
add_filter( 'cherry_data_import_home_regex_replace', 'vichax_remap_shortcodes' );
add_action( 'cherry_data_import_remap_posts',        'vichax_remap_menus' );
add_action( 'cherry_data_import_remap_posts',        'vichax_remap_timetable' );
 ...
 * @return array
 */
function vichax_remap_shortcodes( $regex ) {
 ...
 */
function vichax_remap_timetable( $posts ) {
 ...
 * @param array $posts post remapping array.
 */
function vichax_remap_menus( $posts ) {
