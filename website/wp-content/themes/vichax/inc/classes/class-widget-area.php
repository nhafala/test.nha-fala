...
if ( ! class_exists( 'Vichax_Widget_Area' ) ) {

	/**
	 * Class Vichax_Widget_Area.
	 */
	class Vichax_Widget_Area {
		...
		function __construct() {
			...
			add_action( 'vichax_render_widget_area', array( $this, 'render' ) );
		}
		...
		public function render( $area_id ) {
			...
			$area_id        = apply_filters( 'vichax_rendering_current_widget_area', $area_id );
			...
			$classes = apply_filters( 'vichax_widget_area_classes', $classes, $area_id );
	 ...
	 * @return object
	 */
	function vichax_widget_area() {
		return Vichax_Widget_Area::get_instance();
	}
