...
if ( ! class_exists( 'Vichax_Banner_Widget' ) ) {

	/**
	 * Class Vichax_Banner_Widget.
	 */
	class Vichax_Banner_Widget extends Cherry_Abstract_Widget {
		...
		public function __construct() {
			...
			$this->widget_description = esc_html__( 'Display a banner in your sidebar.', 'vichax' );
			$this->widget_id          = 'vichax_widget_banner';
			$this->widget_name        = esc_html__( 'Banner', 'vichax' );
			$this->settings           = array(
				'title'  => array(
					'type'  => 'text',
					'value' => '',
				...
				'media_id' => array(
					...
					'value'              => '',
					'label'              => esc_html__( 'Source:', 'vichax' ),
				),
				'media_size' => array(
					'type'             => 'select',
					'value'            => 'full',
					...
					'options'          => false,
					'label'            => esc_html__( 'Select image size', 'vichax' ),
					'placeholder'      => esc_html__( 'Select image size', 'vichax' ),
				),
				'link' => array(
					'type'        => 'text',
					'placeholder' => esc_html__( 'Type a banner`s link', 'vichax' ),
					'value'       => esc_url( home_url( '/' ) ),
					'label'       => esc_html__( 'Link:', 'vichax' ),
				),
				'target' => array(
					'type'    => 'select',
					'options' => array(
						'_blank' => esc_html__( 'A new window or tab', 'vichax' ),
						'_self'  => esc_html__( 'The same frame as it was clicked', 'vichax' ),
					),
					'value' => '_blank',
					'label' => esc_html__( 'Opens in:', 'vichax' ),
				),
			);
		...
		public function get_image_sizes() {
			...
			$result = array_merge( $result, array( 'full' => esc_html__( 'Full', 'vichax' ) ) );
...
add_action( 'widgets_init', 'vichax_register_banner_widget' );
/**
 * Register banner widget.
 */
function vichax_register_banner_widget() {
	register_widget( 'Vichax_Banner_Widget' );
}
