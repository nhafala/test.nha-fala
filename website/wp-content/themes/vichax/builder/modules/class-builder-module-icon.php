 ...
 */
class Vichax_Builder_Module_Icon extends Tm_Builder_Module {

	public $function_name;

	public function init() {
		$this->name = esc_html__( 'Icon', 'vichax' );
		$this->icon = 'f1d8';
	...
	public function get_fields() {
		...
		$fields = array(
			'font_icon' => array(
				'label'               => esc_html__( 'Icon', 'vichax' ),
				'type'                => 'text',
				'option_category'     => 'basic_option',
				'class'               => array( 'tm-pb-font-icon' ),
				'renderer'            => 'tm_pb_get_font_icon_list',
				'renderer_with_field' => true,
				'description'         => esc_html__( 'Choose an icon to display.', 'vichax' ),
			),
			'icon_color' => array(
				'label'       => esc_html__( 'Icon Color', 'vichax' ),
				'type'        => 'color-alpha',
				'description' => esc_html__( 'Here you can define a custom color for your icon.', 'vichax' ),
			),
			'use_circle' => array(
				'label'           => esc_html__( 'Circle Icon', 'vichax' ),
				'type'            => 'yes_no_button',
				...
				'description'     => esc_html__( 'Here you can choose whether icon set above should display within a circle.', 'vichax' ),
			),
			'circle_color' => array(
				'label'       => esc_html__( 'Circle Color', 'vichax' ),
				'type'        => 'color-alpha',
				'description' => esc_html__( 'Here you can define a custom color for the icon circle.', 'vichax' ),
			),
			'use_circle_border' => array(
				'label'           => esc_html__( 'Show Circle Border', 'vichax' ),
				'type'            => 'yes_no_button',
				...
				'description'     => esc_html__( 'Here you can choose whether if the icon circle border should display.', 'vichax' ),
			),
			'circle_border_color' => array(
				'label'       => esc_html__( 'Circle Border Color', 'vichax' ),
				'type'        => 'color-alpha',
				'description' => esc_html__( 'Here you can define a custom color for the icon circle border.', 'vichax' ),
			),
			'animation' => array(
				'label'           => esc_html__( 'Icon Animation', 'vichax' ),
				'type'            => 'select',
				'option_category' => 'configuration',
				'options'         => array(
					'top'    => esc_html__( 'Top To Bottom', 'vichax' ),
					'left'   => esc_html__( 'Left To Right', 'vichax' ),
					'right'  => esc_html__( 'Right To Left', 'vichax' ),
					'bottom' => esc_html__( 'Bottom To Top', 'vichax' ),
					'off'    => esc_html__( 'No Animation', 'vichax' ),
				),
				'description'     => esc_html__( 'This controls the direction of the lazy-loading animation.', 'vichax' ),
			),
			'icon_orientation' => array(
				'label'           => esc_html__( 'Icon Orientation', 'vichax' ),
				'type'            => 'select',
				'option_category' => 'layout',
				'options'         => array(
				...
				'description'     => esc_html__( 'This will control how your icon is aligned.', 'vichax' ),
			),
			'use_icon_font_size' => array(
				'label'           => esc_html__( 'Use Icon Font Size', 'vichax' ),
				'type'            => 'yes_no_button',
			...
			'icon_font_size' => array(
				'label'           => esc_html__( 'Icon Font Size', 'vichax' ),
				'type'            => 'range',
				'option_category' => 'font_option',
				'tab_slug'        => 'advanced',
				'default'         => '50px',
			...
			'circle_size' => array(
				...
				'description'     => esc_html__( 'Here you can define a custom diameter for the icon circle.', 'vichax' ),
				'mobile_options'  => true,
				'depends_default' => true,
			),
			'circle_border_width' => array(
				...
				'description'     => esc_html__( 'Here you can define a custom width for the icon circle border.', 'vichax' ),
				'depends_default' => true,
			),
...
new Vichax_Builder_Module_Icon;
